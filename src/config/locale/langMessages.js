export default {
    en:{
        nav_item_brand_dashboard:'Dashboard',
        nav_item_brand_main:'Main',
        nav_item_signup:'Signup',
        nav_item_login:'Login',
        nav_item_mybooks:'My Books',
        nav_item_booksapi:'Books Api',
        nav_item_logout:'Logout',

        page_home_page_title:'Home',

        page_forgotpassword_page_title:'Forgot Password',
    ...
    ru:{
        ...
        nav_item_mybooks:'мои книги',
        nav_item_booksapi:'книги апи',
        nav_item_logout:'выйти',

        page_home_page_title:'Главный',

        page_forgotpassword_page_title:'Забыли пароль',
    ...
    lt:{
        ...
        nav_item_mybooks:'Mano knygos',
        nav_item_booksapi:'Knygos API',
        nav_item_logout:'Atsijungti',

        page_home_page_title:'Pagrindinis',

        page_forgotpassword_page_title:'Pamiršote slaptažodį',
